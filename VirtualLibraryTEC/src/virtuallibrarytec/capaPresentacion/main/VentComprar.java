 ...
 * @author sebas
 */
public class VentComprar extends javax.swing.JDialog {
    private VentRegistroCompras ventCom;
    private GestionLibros libros;

    public VentRegistroCompras getVentCom() {
        return ventCom;
    }

    public void setVentCom(VentRegistroCompras ventCom) {
        this.ventCom = ventCom;
    }
     ...
     * @param principal
     */
    public VentComprar(java.awt.Dialog parent, boolean modal, VentRegistroCompras ventCom) {
        super(parent,modal);
        initComponents();
        this.ventCom = ventCom;
   ...
   /** public void actualizarTabla() {
    ...
    public void eliminarDesdeTabla() throws Exception {
        ...
        VentComprar crear_Libro = new VentComprar(ventCom, rootPaneCheckingEnabled,ventCom);
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Compra de Libros");
